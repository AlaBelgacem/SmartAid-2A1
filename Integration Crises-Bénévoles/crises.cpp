...
Crises::Crises ( QString nom,QString adresse, int niveau,QString description,  QString date_cr,QString etat, QString latitude, QString longitude) //classe::constructeur
...
query.prepare("insert into crises (nom,adresse,niveau,description,date_cr,etat,latitude,longitude)"
              "values(:nom,:adresse,:niveau,:description,:date_cr,:etat, :latitude ,:longitude)");
...
bool Crises::modifier(int id, QString nom,QString adresse, int niveau,QString description,  QString date_cr,QString etat, QString latitude, QString longitude)
{
    QSqlQuery query;


    query.prepare("update Crises set Nom = :nom, Adresse= :adresse, Niveau= :niveau, Description= :description, Date_Cr= :date_cr,Etat= :etat, Latitude= :latitude, Longitude= :longitude WHERE ID_CR = :id");
    query.bindValue(":nom", nom);
    query.bindValue(":adresse", adresse);
