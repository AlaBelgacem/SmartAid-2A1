...
void MainWindow::on_Bouton_Certifications_Menu_clicked()
{
    ...
    const QString filename("C:/Users/louay/Desktop/smart_aid/certification.pdf");
    ...
    else
    {
        ...
        if(qry.exec())
        {
            while(qry.next())
            {
                ...
                QTextDocument document;
                document.setHtml(html);
                const QString filename("C:/cygwin64/home/louay/Design.pdf");
                const QString filename2("C:/cygwin64/home/louay/Affiche-1.png");
...
//#pdftoppm -png c.pdf test.png
                ...
                QProcess::startDetached("C:\\cygwin64\\bin\\mintty.exe",QStringList() << "/home/louay/convrt.sh");
