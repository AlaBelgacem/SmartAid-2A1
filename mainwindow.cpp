...
//arduino
    int ret=A.connect_arduino();
        ...
        /////////////////////////////////////////////////////////// TAB NECE ///////////////////////////////////////////////////
            QListWidgetItem *consulter= new QListWidgetItem(QIcon(":/icons/icons/consulter.png"),"Consulter");
            ui->listWidget_Ne->setFlow(QListWidget::LeftToRight);

            ui->listWidget_Ne->addItem(consulter);

            QListWidgetItem *rdv= new QListWidgetItem(QIcon(":/icons/icons/schedule.png"),"Rendez-Vous");
            ui->listWidget_Ne->addItem(rdv);

            QListWidgetItem *stat= new QListWidgetItem(QIcon(":/icons/icons/qr-code-scan.png"),"QrCode");
            ui->listWidget_Ne->addItem(stat);

            QListWidgetItem *qr= new QListWidgetItem(QIcon(":/icons/icons/stat.png"),"Statistiques");
            ui->listWidget_Ne->addItem(qr);

            QListWidgetItem *donner= new QListWidgetItem(QIcon(":/icons/icons/stat.png"),"Donner");
            ui->listWidget_Ne->addItem(donner);
            ...
            QMovie *gif_donner = new QMovie(":/images/images/donner.gif");
            ...
            ui->label_donner->setMovie(gif_donner);
...
void MainWindow::on_listWidget_Ne_itemClicked(QListWidgetItem *item)
{
    ...
    if (selectedvalue == "Donner"){
        ui->stackedWidget_Ne->setCurrentIndex(4);
    }
    /*if (selectedvalue == "Gestion Crises"){
        ui->stackedWidget->setCurrentIndex(5);
    }
...
void MainWindow::on_rechNe_textChanged(const QString &arg1)
{
    QString search=arg1;
...
void MainWindow::on_stackedWidget_Ne_currentChanged(int arg1)
{
    ...
    if(arg1==3){
       ...
       // set dark background gradient:
        ...
        ui->customPlot2->setBackground(QBrush("#fff"));

        // create empty bar chart objects:
        QCPBars *besoin = new QCPBars(ui->customPlot2->xAxis, ui->customPlot2->yAxis);
        ...
        ui->customPlot2->xAxis->setBasePen(QPen(Qt::black));
        ui->customPlot2->xAxis->setTickPen(QPen(Qt::black));
        ui->customPlot2->xAxis->grid()->setVisible(true);
        ui->customPlot2->xAxis->grid()->setPen(QPen(QColor(130, 130, 130), 0, Qt::DotLine));
        ui->customPlot2->xAxis->setTickLabelColor(Qt::black);
        ui->customPlot2->xAxis->setLabelColor(Qt::black);

        // prepare y axis:
        ui->customPlot2->yAxis->setRange(0, 12.1);
        ui->customPlot2->yAxis->setPadding(5); // a bit more space to the left border
        ui->customPlot2->yAxis->setLabel("Nombre de nécessiteux\n par Besoin");
        ui->customPlot2->yAxis->setBasePen(QPen(Qt::black));
        ui->customPlot2->yAxis->setTickPen(QPen(Qt::black));
        ui->customPlot2->yAxis->setSubTickPen(QPen(Qt::black));
        ui->customPlot2->yAxis->grid()->setSubGridVisible(true);
        ui->customPlot2->yAxis->setTickLabelColor(Qt::black);
        ui->customPlot2->yAxis->setLabelColor(Qt::black);
        ui->customPlot2->yAxis->grid()->setPen(QPen(QColor("#000"), 0, Qt::SolidLine));
        ui->customPlot2->yAxis->grid()->setSubGridPen(QPen(QColor("#000"), 0, Qt::DotLine));
        ...
        ui->customPlot2->legend->setBrush(QColor("#fff"));
